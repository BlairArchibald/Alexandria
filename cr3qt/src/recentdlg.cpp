    ...
    m_docview(docView)
{
    ...
    m_ui->tableWidget->horizontalHeader()->setResizeMode( 2, QHeaderView::Stretch );
    ...
    for ( int i=firstItem; i<files.length(); i++ ) {
        ...
        //m_ui->tableWidget->verticalHeader()->setResizeMode( i-firstItem, QHeaderView::Stretch );
